...
5) _Модуль requests_redis.py_ - Модуль содержит в себе функции для работы с Redis, позволяющие записывать в кэш различную информацию под каждого пользователя VK:
