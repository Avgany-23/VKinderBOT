...
2) запускает телеграм бота, если он включен (include = True) в ```[settings.py](https://github.com/Avgany-23/VKinderBOT/blob/78792e50ef241102af7e43cc550b72cb2ee8c31c/settings.py#L43)```
